...
A comprehensive research study on fine-tuning [Qwen2.5-1.5B](https://huggingface.co/Qwen/Qwen2.5-1.5B) for structured instructional generation, and systematically benchmarking its serving performance and generation quality across different post-training quantization (PTQ) formats (**FP16, AWQ, NF4, FP8**) on two high-performance inference engines: **vLLM** and **SGLang** under strict hardware limits (NVIDIA RTX 3050 Laptop GPU with 4 GB VRAM).
